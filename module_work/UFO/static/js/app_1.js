...
// You want to clear a table before adding additional information
...
function buildTable(data) {
    ...
    data.forEach((dataRow) => {
      // Append a row to the table body. this code is finding a tbody in html and appending "tr" which adds a new table row
